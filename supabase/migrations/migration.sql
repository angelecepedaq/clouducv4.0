...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:kbRA7TnFc2fgJMBW5vplkg==$PY+moDr/WvT8oym6hENn9m9YV4O5v/eadZZdN5ky5ug=:jgta6IRDsbUYse3vIzHwGnWPdD0fa9vOFGVEZzrd4zA=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:8TFQzkuouZV5D6ytK0HprQ==$M0Khko46B5i387NWJYbghOErBilZP4L2Jb0cEcUUz3Y=:Qg6nh30Fo+e8urwh/DkPZwGUT0ejck65CsPqKOPispo=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:JiJ9c3KrngRiwdXWWrSCYw==$meAab3zFLasc89AoeeUJVaCF0L7DJGVzkdN11A761pY=:SwsG1pCRlLygVQbvGZbIzjLIjjT/CO2JC6KXv6XmGyw=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Y+9DbUmvM7Nwqwh9lIuzVw==$z7JiaXHkXeLBd8wnGQoPSRuHIUXwR5fYMHSl+BUscgk=:mrMgB16ktlGv0HIVTX3oWh2kx8iQiTkBO2zLtIW1nNM=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:TJL4mfOP8h3TAs3B9JyYiA==$OuFUC20xr5/rvHARcQsGEvB/J5Srl/tps3jhs7Vg1mw=:vilN+gEuC+m637FOpwpxkl6ipUYL/FOCF0aRVk9KweY=';
-- CREATE ROLE "supabase_etl_admin";
-- ALTER ROLE "supabase_etl_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:y98tk6XzfT1qyg/k7qknqQ==$y5WzFsLvnaZlhGBVzyiZAYNfE4PsLTNbmQL96YBafXA=:4Qi1eraY7HB7ToNpb06TE3zvD+hFEIshzsuh33kjRqg=';
-- CREATE ROLE "supabase_privileged_role";
-- ALTER ROLE "supabase_privileged_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_read_only_user";
-- ALTER ROLE "supabase_read_only_user" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:oFB5XP69qQlMiyQLi3+ocw==$rq9VMxkIBxGdupvff+XLJjXGNyfWG596C/80MhWDGXY=:xv2gqz996XcJ1pRtupP6fbtq5WHZMbzl5Cfrr6Q8jik=';
-- CREATE ROLE "supabase_realtime_admin";
-- ALTER ROLE "supabase_realtime_admin" WITH NOINHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_replication_admin";
-- ALTER ROLE "supabase_replication_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:T8vlyn51ugEvDVdr7CC+Nw==$SQZ85u7CCEsc29gCOI7IikHNBR9IbgADp6YO0vGQRXE=:k5DKzNec0c2dK15o8+Z8znIsVa2h+4t300dMQFy6Q6s=';
-- CREATE ROLE "supabase_storage_admin";
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Gcpug/E2NbNvNPQVLhlE5A==$v6z8sDlijcwjNCR1iODw9A8UH5QRfWRYZxULQtXseDc=:5+5vCgR8+O6MXqo7h8Dh3iZLEDilc9JRmlkjBcdNdZ8=';
...
--
-- Name: can_insert_mensaje("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."can_insert_mensaje"("p_evento_id" "uuid") RETURNS boolean
...
--
-- Name: can_see_mensajes_evento("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."can_see_mensajes_evento"("p_evento_id" "uuid") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 FROM public.eventos WHERE id = p_evento_id AND user_id = auth.uid()
...
--
-- Name: notify_new_event_category(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."notify_new_event_category"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    INSERT INTO notificaciones (user_id, actor_id, evento_id, tipo)
    SELECT p.id, NEW.user_id, NEW.id, 'nuevo_evento_categoria'
    FROM profiles p
    WHERE NEW.categoria = ANY(p.categorias_favoritas)
...
--
-- Name: toggle_guardado("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."toggle_guardado"("p_evento_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_user_id uuid;
...
BEGIN
  ...
  SELECT EXISTS(
    SELECT 1 FROM eventos_guardados 
    WHERE evento_id = p_evento_id AND user_id = v_user_id
  ) INTO v_exists;

  IF v_exists THEN
    DELETE FROM eventos_guardados WHERE evento_id = p_evento_id AND user_id = v_user_id;
    RETURN false; -- Ahora NO está guardado
  ELSE
    INSERT INTO eventos_guardados (evento_id, user_id) VALUES (p_evento_id, v_user_id);
    RETURN true;  -- Ahora SÍ está guardado
  END IF;
END;
$$;
...
--
-- Name: toggle_like("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."toggle_like"("p_evento_id" "uuid") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_user_id uuid;
...
CREATE TABLE "public"."eventos" (
    ...
    "avatares" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "user_id" "uuid",
    "direccion" "text",
    "descripcion" "text" DEFAULT ''::"text" NOT NULL,
    "likes" integer DEFAULT 0 NOT NULL,
    CONSTRAINT "eventos_categoria_check" CHECK (("categoria" = ANY (ARRAY['Académicos'::"text", 'Culturales'::"text", 'Deportivos'::"text", 'Comerciales'::"text"])))
);


--
-- Name: eventos_guardados; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."eventos_guardados" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "evento_id" "uuid",
    "user_id" "uuid",
...
--
-- Name: likes_evento; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."likes_evento" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "evento_id" "uuid",
    "user_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"()
...
--
-- Name: likes_mensaje; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."likes_mensaje" (
...
--
-- Name: mensajes_evento; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."mensajes_evento" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "reply_to_id" "uuid",
    CONSTRAINT "mensajes_evento_contenido_check" CHECK ((("char_length"("contenido") <= 500) AND ("char_length"("contenido") > 0)))
);
...
CREATE TABLE "public"."profiles" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "categorias_favoritas" "text"[] DEFAULT '{}'::"text"[],
    "avatar_url" "text"
);
...
--
-- Name: eventos_guardados eventos_guardados_evento_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."eventos_guardados"
    ADD CONSTRAINT "eventos_guardados_evento_id_user_id_key" UNIQUE ("evento_id", "user_id");


--
-- Name: eventos_guardados eventos_guardados_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."eventos_guardados"
    ADD CONSTRAINT "eventos_guardados_pkey" PRIMARY KEY ("id");
...
--
-- Name: likes_evento likes_evento_evento_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_evento"
    ADD CONSTRAINT "likes_evento_evento_id_user_id_key" UNIQUE ("evento_id", "user_id");


--
-- Name: likes_evento likes_evento_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_evento"
    ADD CONSTRAINT "likes_evento_pkey" PRIMARY KEY ("id");


--
-- Name: likes_mensaje likes_mensaje_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_mensaje"
    ADD CONSTRAINT "likes_mensaje_pkey" PRIMARY KEY ("mensaje_id", "user_id");


--
-- Name: mensajes_evento mensajes_evento_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."mensajes_evento"
    ADD CONSTRAINT "mensajes_evento_pkey" PRIMARY KEY ("id");
...
--
-- Name: mensajes_evento_evento_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "mensajes_evento_evento_id_idx" ON "public"."mensajes_evento" USING "btree" ("evento_id");


--
-- Name: mensajes_evento_remitente_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "mensajes_evento_remitente_id_idx" ON "public"."mensajes_evento" USING "btree" ("remitente_id");
...
--
-- Name: eventos on_insert_evento_notify; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "on_insert_evento_notify" AFTER INSERT ON "public"."eventos" FOR EACH ROW EXECUTE FUNCTION "public"."notify_new_event_category"();


--
-- Name: likes_evento on_like_evento; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "on_like_evento" AFTER INSERT ON "public"."likes_evento" FOR EACH ROW EXECUTE FUNCTION "public"."handle_new_like"();
...
--
-- Name: eventos_guardados eventos_guardados_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."eventos_guardados"
    ADD CONSTRAINT "eventos_guardados_evento_id_fkey" FOREIGN KEY ("evento_id") REFERENCES "public"."eventos"("id") ON DELETE CASCADE;


--
-- Name: eventos_guardados eventos_guardados_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."eventos_guardados"
    ADD CONSTRAINT "eventos_guardados_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."eventos"
    ADD CONSTRAINT "eventos_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;


--
-- Name: likes_evento likes_evento_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_evento"
    ADD CONSTRAINT "likes_evento_evento_id_fkey" FOREIGN KEY ("evento_id") REFERENCES "public"."eventos"("id") ON DELETE CASCADE;


--
-- Name: likes_evento likes_evento_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_evento"
    ADD CONSTRAINT "likes_evento_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: likes_mensaje likes_mensaje_mensaje_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_mensaje"
    ADD CONSTRAINT "likes_mensaje_mensaje_id_fkey" FOREIGN KEY ("mensaje_id") REFERENCES "public"."mensajes_evento"("id") ON DELETE CASCADE;


--
-- Name: likes_mensaje likes_mensaje_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."likes_mensaje"
    ADD CONSTRAINT "likes_mensaje_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;


--
-- Name: mensajes_evento mensajes_evento_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."mensajes_evento"
    ADD CONSTRAINT "mensajes_evento_evento_id_fkey" FOREIGN KEY ("evento_id") REFERENCES "public"."eventos"("id") ON DELETE CASCADE;


--
-- Name: mensajes_evento mensajes_evento_remitente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."mensajes_evento"
    ADD CONSTRAINT "mensajes_evento_remitente_id_fkey" FOREIGN KEY ("remitente_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: mensajes_evento mensajes_evento_reply_to_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."mensajes_evento"
    ADD CONSTRAINT "mensajes_evento_reply_to_id_fkey" FOREIGN KEY ("reply_to_id") REFERENCES "public"."mensajes_evento"("id") ON DELETE CASCADE;


--
-- Name: notificaciones notificaciones_actor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."notificaciones"
    ADD CONSTRAINT "notificaciones_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;


--
-- Name: notificaciones notificaciones_evento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: likes_evento Public likes_evento select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Public likes_evento select" ON "public"."likes_evento" FOR SELECT USING (true);


--
-- Name: likes_evento Users can like; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can like" ON "public"."likes_evento" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: eventos_guardados Users can save events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can save events" ON "public"."eventos_guardados" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: likes_evento Users can unlike; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can unlike" ON "public"."likes_evento" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: eventos_guardados Users can unsave events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can unsave events" ON "public"."eventos_guardados" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: eventos_guardados Users can view their saved events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their saved events" ON "public"."eventos_guardados" FOR SELECT USING (("auth"."uid"() = "user_id"));


--
-- Name: profiles Usuarios actualizan su propio perfil; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios actualizan su propio perfil" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK ((NOT ("role" IS DISTINCT FROM "public"."get_user_role"("auth"."uid"()))));


--
-- Name: notificaciones Usuarios pueden actualizar sus propias notificaciones; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios pueden actualizar sus propias notificaciones" ON "public"."notificaciones" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: notificaciones Usuarios pueden ver sus propias notificaciones; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Usuarios pueden ver sus propias notificaciones" ON "public"."notificaciones" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: profiles Usuarios ven su propio perfil; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: likes_mensaje eliminar_like_mensaje; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "eliminar_like_mensaje" ON "public"."likes_mensaje" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: mensajes_evento eliminar_mensaje_propio; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "eliminar_mensaje_propio" ON "public"."mensajes_evento" FOR DELETE TO "authenticated" USING (("remitente_id" = "auth"."uid"()));
...
--
-- Name: eventos_guardados; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."eventos_guardados" ENABLE ROW LEVEL SECURITY;

--
-- Name: likes_mensaje insertar_like_mensaje; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY "insertar_mensaje_publico" ON "public"."mensajes_evento" FOR INSERT TO "authenticated" WITH CHECK (("remitente_id" = "auth"."uid"()));


--
-- Name: eventos lectura_publica_eventos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "lectura_publica_eventos" ON "public"."eventos" FOR SELECT TO "authenticated", "anon" USING (true);


--
-- Name: likes_evento; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."likes_evento" ENABLE ROW LEVEL SECURITY;

--
-- Name: likes_mensaje; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."likes_mensaje" ENABLE ROW LEVEL SECURITY;

--
-- Name: mensajes_evento; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: eventos solo_autenticados_insertan_eventos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "solo_autenticados_insertan_eventos" ON "public"."eventos" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: eventos solo_dueno_actualiza_evento; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "solo_dueno_actualiza_evento" ON "public"."eventos" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: eventos solo_dueno_elimina_evento; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "solo_dueno_elimina_evento" ON "public"."eventos" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "user_id"));


--
-- Name: likes_mensaje ver_likes_mensaje_publico; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "ver_likes_mensaje_publico" ON "public"."likes_mensaje" FOR SELECT USING (true);


--
-- Name: mensajes_evento ver_mensajes_publico; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "ver_mensajes_publico" ON "public"."mensajes_evento" FOR SELECT USING (true);
...
--
-- Name: supabase_realtime eventos; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime likes_evento; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."likes_evento";


--
-- Name: supabase_realtime mensajes_evento; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."mensajes_evento";


--
-- Name: supabase_realtime notificaciones; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
avatars	avatars	\N	2026-06-07 02:33:01.629222+00	2026-06-07 02:33:01.629222+00	t	f	\N	\N	\N	STANDARD
\.
